document.addEventListener("DOMContentLoaded", function() {
    ...
    editBtn.addEventListener("click", function() {
        ...
        form.querySelector("[name='branch_manager']").value = branch.branch_manager || "";
        form.querySelector("[name='branch_level']").value = branch.branch_level || "";
        form.querySelector("[name='branch_head']").value = branch.branch_head || "";
        form.querySelector("[name='school_gender']").value = branch.school_gender || "";
    ...
    const classColors = ["#0d6efd", "#198754", "#ffc107", "#dc3545", "#6f42c1", "#20c997"];
